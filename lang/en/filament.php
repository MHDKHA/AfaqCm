...
return [
    ...
    */
    'resources' => [
        ...
        'tool_performance_level' => [
            'label' => 'Tool Performance Level',
            'plural_label' => 'Tool Performance Levels',
            'navigation_label' => 'Tool Performance Levels',
        ],
        'tool_request' => [
            'label' => 'Tool Request',
            'plural_label' => 'Tool Requests',
            'navigation_label' => 'Tool Requests',
            'navigation_group' => 'User Management',
        ],
        'tool_subscription' => [
            'label' => 'Tool Subscription',
            'plural_label' => 'Tool Subscriptions',
            'navigation_label' => 'Tool Subscriptions',
            'navigation_group' => 'User Management',
        ],
    ],
    ...
    */
    'fields' => [
        ...
        'recommendation_ar' => 'Recommendation (Arabic)',
        ...
        'message' => 'Message',
        'quotation_sent_at' => 'Quotation Sent At',
        'approved' => 'Approved',
