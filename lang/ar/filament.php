...
return [
    ...
    */
    'resources' => [
        ...
        'account' => [
            'label' => 'حساب بنكي',
            'plural_label' => 'الحسابات البنكية',
            'navigation_label' => 'الحسابات البنكية',
        ],
        'tool_performance_level' => [
            'label' => 'مستوى أداء الأداة',
            'plural_label' => 'مستويات أداء الأداة',
            'navigation_label' => 'مستويات أداء الأداة',
        ],
        'tool_request' => [
            'label' => 'طلب أداة',
            'plural_label' => 'طلبات الأدوات',
            'navigation_label' => 'طلبات الأدوات',
            'navigation_group' => 'إدارة المستخدمين',
        ],
        'tool_subscription' => [
            'label' => 'اشتراك الأداة',
            'plural_label' => 'اشتراكات الأدوات',
            'navigation_label' => 'اشتراكات الأدوات',
            'navigation_group' => 'إدارة المستخدمين',
        ],
    ],
    ...
    */
    'fields' => [
        ...
        // Tool Performance Level fields
        'code' => 'الرمز',
        'min_percentage' => 'الحد الأدنى للنسبة',
        'color' => 'اللون',
        'text_en' => 'النص (بالإنجليزية)',
        'text_ar' => 'النص (بالعربية)',
        'recommendation_en' => 'التوصية (بالإنجليزية)',
        'recommendation_ar' => 'التوصية (بالعربية)',

        // Tool Subscription fields
        'expires_at' => 'تاريخ الانتهاء',
        'features' => 'الميزات',
        'amount' => 'المبلغ',
        'bank_account' => 'الحساب البنكي',
        'message' => 'الرسالة',
        'quotation_sent_at' => 'تاريخ إرسال العرض',
        'approved' => 'موافق عليه',
